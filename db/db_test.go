...
//	r := require.New(t)
//	_, err := dbT.UserFund(100, 1)
//	r.Error(err)
//	u := entity.User{
//		Name:    "Jana",
//		Balance: 300,
//	}
//	_, err = dbT.SaveUser(u)
//	r.NoError(err)
//	var wg sync.WaitGroup
//	wg.Add(100)
//	for i := 0; i < 100; i++ {
//		go func() {
//			_, err := dbT.UserFund(1, 1)
//			r.NoError(err)
//			wg.Done()
//		}()
//	}
//	wg.Wait()
//	us, err := dbT.GetUser(1)
//	r.NoError(err)
...
//	_, err = dbT.SaveUser(u)
//	r.NoError(err)
//	_, err = dbT.SaveUser(y)
//	r.NoError(err)
//	var wg sync.WaitGroup
//	wg.Add(200)
//	for i := 0; i < 100; i++ {
//		go func() {
//			_, err := dbT.UserTake(2, 400)
//			r.Error(err)
//			wg.Done()
//		}()
//	}
...
//	}
//	wg.Wait()
//	c, err := dbT.CountUsers()
//	r.NoError(err)
//	r.Equal(100, c)
//
//	for i := 1; i < 101; i++ {
//		us, err := dbT.GetUser(i)
//		r.NoError(err)
